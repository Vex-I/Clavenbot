...
class FeedbackForm(discord.ui.Modal, title="Feedback"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        self.answer = self.feedback.value  ##Edited to print the content instead of the object itself
        self.stop()
...
class General(commands.Cog, name="general"):
    ...
    async def botinfo(self, context: Context) -> None:
        ...
        """
        embed = discord.Embed(
            description="Beep Boop, I am Clavenbot! Use me to record coordinates, lookup memes, and check]" \
            "the Minecraft server's status",
            color=0xBEBEFE,
        )
        embed.set_author(name="Bot Information")
        embed.add_field(name="Owner:", value="Vex_I", inline=True)
        embed.add_field(
            name="Version:", value="1.0", inline=True
        )
        embed.set_footer(text = "Used [Krypton's](https://krypton.ninja) template")
        embed.add_field(
